...
st.markdown(
    ...
    .msg-row {
        ...
        scroll-margin-top: 150px; /* Offset scroll position to keep clear of fixed header + nav */
    }
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        div[data-testid="stHorizontalBlock"] {
            position: fixed !important;
            top: 84px !important; /* sits directly below title container */
            left: 0 !important;
            right: 0 !important;
            background: #faf9f7 !important;
        ...
        .chat-area {
            max-width: 620px;
            margin: 0 auto;
            padding: 152px 0 40px 0 !important; /* Spacing for fixed header and nav tray */
        }
